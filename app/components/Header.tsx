...
import { Menu, X, Monitor, Phone, Mail, Clock } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <div className="hidden sm:flex items-center space-x-4">
              <span className="flex items-center gap-1"><Phone className="w-3 h-3" />(312) 555-0142</span>
              <span className="flex items-center gap-1"><Mail className="w-3 h-3" />info@sentinelit.com</span>
            </div>
          ...
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="flex items-center space-x-3 hover:opacity-80 transition-opacity duration-200">
              <div className="flex-shrink-0 w-10 h-10 bg-primary-900 rounded-lg flex items-center justify-center" style={{ clipPath: 'polygon(0 0, 100% 0, 100% 85%, 0 100%)' }}>
                <Monitor className="w-6 h-6 text-accent-400" />
              </div>
              <span className="font-display text-lg font-bold text-primary-900 uppercase tracking-wide hidden sm:block">Sentinel IT Solutions</span>
            </Link>
