...
export const metadata: Metadata = {
  title: 'Services | Sentinel IT Solutions',
  description: 'Explore our managed IT services, cybersecurity solutions, cloud migration, and help desk support for small and mid-size businesses.',
}
